...
const OnGenarateTrip = async () => {
 ...
 const login = useGoogleLogin({
  ...
  // ---------------- UI ----------------
  return (
    <div className="bg-gray-100 px-5 sm:px-10 md:px-20 lg:px-40 xl:px-56 py-10 relative animate-fadeIn">
      {/* Header */}
      <div>
      ...
      <div className="my-10 flex justify-end">
        <button
          ...
          disabled={loading}
          className={`px-6 py-3 text-white font-semibold rounded-xl shadow-md transition-all duration-300 flex items-center gap-2 ${
            loading
